...
Every statement is covered, `match` included, which is the last one to land.
...
OK = [
    ...
    "try:\n    def f(): pass\nexcept:\n    class C: pass\n",
    "with a:\n    async def f(): pass\n",
    # match, whose two words are ordinary names anywhere else.
    "match[x]",
    "match + 1",
    "match: int = 1",
    "match.x",
    ...
    "match = case = 1",
    "print(match, case)",
    # The statement itself, and what its subject may be.
    "match x:\n    case 1:\n        pass\n",
    "match x:\n    case 1: pass\n",
    "match (x):\n    case 1: pass\n",
    "match x, y:\n    case 1: pass\n",
    ...
    "match x:\n    case a.b.c: pass\n",
    "match x:\n    case Color.RED: pass\n",
    # as, or, and the two of them together.
    "match x:\n    case 1 as y: pass\n",
    "match x:\n    case _ as y: pass\n",
    "match x:\n    case [1] as y: pass\n",
    "match x:\n    case 1 | 2: pass\n",
    ...
    "match x:\n    case a.b | c.d: pass\n",
    "match x:\n    case [1] | (2,) | {}: pass\n",
    # Sequences, with and without brackets.
    "match x:\n    case []: pass\n",
    "match x:\n    case [1]: pass\n",
    "match x:\n    case [1,]: pass\n",
    "match x:\n    case [1, 2]: pass\n",
    ...
    "match x:\n    case y if (z := y): pass\n",
    # A guard right after an `as` target, which is where a name has to be taken
    # as a name rather than read as an expression that would swallow the `if`.
    "match x:\n    case _ as y if y: pass\n",
    "match x:\n    case 1 as y if (y if y else 0): pass\n",
    "match x:\n    case [1] as y if y: pass\n",
    "match x:\n    case 1, 2 if y: pass\n",
    # Bodies, and match nested in every block that has one.
    "match x:\n    case 1:\n        a = 1\n        b = 2\n",
    "match x:\n    case 1:\n        match y:\n            case 2: pass\n",
    "if a:\n    match x:\n        case 1: pass\n",
    "def f():\n    match x:\n        case 1: pass\n",
...
ERRORS = [
    ...
    "@d\n@e\nx = 1",
    "if x:\n    @d\n    y = 1\n",
    # match, whose errors are its own even though its words are not.
    "match x\n    case 1: pass\n",
    "match x y:\n    case 1: pass\n",
    "match *x:\n    case 1: pass\n",
    "match x:\n",
    ...
    "match x:\n    case 1\n        pass\n",
    "match x:\n    case 1 x:\n        pass\n",
    # Patterns that look like expressions and are not.
    "match x:\n    case 1 + x: pass\n",
    "match x:\n    case 1 + 2: pass\n",
    "match x:\n    case 1j + 2: pass\n",
    "match x:\n    case 1 + 2j + 3j: pass\n",
    ...
    "match x:\n    case -x: pass\n",
    "match x:\n    case 1 if: pass\n",
    "match x:\n    case 0 if 1 else 2: pass\n",
    "match x:\n    case not x: pass\n",
    "match x:\n    case x < 1: pass\n",
    "match x:\n    case f(x)(): pass\n",
    "match x:\n    case x[0]: pass\n",
    # The wildcard, which is matched before anything else can be.
    "match x:\n    case _.x: pass\n",
    "match x:\n    case _(y): pass\n",
    "match x:\n    case _ as _: pass\n",
    "match x:\n    case 1 as _: pass\n",
    "match x:\n    case {**_}: pass\n",
    # as targets that are not names.
    "match x:\n    case 1 as 2: pass\n",
    "match x:\n    case 1 as x.y: pass\n",
    "match x:\n    case 1 as f(): pass\n",
    "match x:\n    case 1 as None: pass\n",
    "match x:\n    case 1 as [y]: pass\n",
    # Stars, which need a sequence around them.
    "match x:\n    case *x: pass\n",
    "match x:\n    case (*x): pass\n",
    "match x:\n    case [*1]: pass\n",
    # Mapping keys, which are literals or dotted names and nothing else.
    "match x:\n    case {x: 1}: pass\n",
    "match x:\n    case {**rest, 'a': 1}: pass\n",
    "match x:\n    case {'a'}: pass\n",
    "match x:\n    case {**1}: pass\n",
